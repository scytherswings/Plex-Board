...
class ServicesControllerTest < ActionController::TestCase
  ...
  test 'should create service' do
    assert_difference('Service.count') do
      post :create, params: {service: { name: 'test_create', ip: '172.111.3.1', port: 80, dns_name: 'test_create', url: 'test_create'}}
    end
  ...
  test 'should show service' do
    get :show, params: {id: @generic_service_one.id}
    assert_response :success
    assert_select 'title', "Plex-Board | #{@generic_service_one.name}"
  end

  test 'should get edit' do
    get :edit, params:{id: @generic_service_one.id}
    assert_response :success
    assert_select 'title', "Plex-Board | Edit #{@generic_service_one.name}"
  end

  test 'should update service' do
    patch :update, params: {id: @generic_service_one.id, service: {name: 'test2', ip: '172.123.1.1', dns_name: 'test', url: 'test' }}
    assert_redirected_to service_path(assigns(:service))
  end

  test 'should destroy service' do
    assert_difference('Service.count', -1) do
      assert delete :destroy, params: {id: @generic_service_one.id}
    end
